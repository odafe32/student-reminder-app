                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="checkbox" name="email_notification" id="email_notification" class="form-check-input" value="1">
                            <label for="email_notification" class="form-check-label">Email Notification</label>
                        </div>
                        <div class="form-check">
                            <input type="checkbox" name="sms_notification" id="sms_notification" class="form-check-input" value="1">
                            <label for="sms_notification" class="form-check-label">SMS Notification</label>
                        </div>
                        <div class="form-check">
            ...
            <form method="POST" id="editTaskForm" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-check">
                            <input type="checkbox" name="sms_notification" id="edit_sms_notification" class="form-check-input" value="1">
                            <label for="edit_sms_notification" class="form-check-label">SMS Notification</label>
                        </div>
                        <div class="form-check">
...
function editTask(task) {
    ...
    document.getElementById('edit_sms_notification').checked = task.sms_notification;
